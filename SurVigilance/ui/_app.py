...
st.markdown(
    ...
    events that may be associated the usage of pharmaceutical drugs or vaccines. The goal of this application is to 
    enable analysis that aids in informed decision-making in the realm of healthcare and pharmacovigilance. 
    </div>
    """,
    unsafe_allow_html=True,
)
